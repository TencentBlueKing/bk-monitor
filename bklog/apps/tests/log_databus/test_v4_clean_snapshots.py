"""Auto-generated V4 clean rule snapshots. DO NOT EDIT MANUALLY."""
...
EXPECTED_JSON_RETAIN_ORIGINAL = {
    "clean_rules": [
        ...
        {
            "input_id": "bk_separator_object",
            "output_id": "status_code",
            "operator": {
                "type": "assign",
                "key_index": "status_code",
                "alias": "status_code",
                "output_type": "long",
                "default_value": None,
            },
...
EXPECTED_JSON_EXTRA_AND_FAILURE = {
    "clean_rules": [
        ...
        },
        {
            "input_id": "iter_string",
            "output_id": "bk_separator_object",
            "operator": {"type": "json_de", "error_strategy": "null"},
        },
        {
            "input_id": "bk_separator_object",
            "output_id": "level",
        ...
        {
            "input_id": "bk_separator_object",
            "output_id": "__ext_json_temp_bk_separator_object",
            "operator": {"type": "delete", "key_index": [{"type": "key", "value": "level"}]},
        },
        {
            "input_id": "__ext_json_temp_bk_separator_object",
...
EXPECTED_REGEXP_BASIC = {
    "clean_rules": [
        ...
        {
            "input_id": "bk_separator_object",
            "output_id": "request_ip",
            "operator": {
                "type": "assign",
                "key_index": "request_ip",
                "alias": "request_ip",
                "output_type": "string",
                "default_value": None,
            },
        ...
        {
            "input_id": "bk_separator_object",
            "output_id": "request_time",
            "operator": {
                "type": "assign",
                "key_index": "request_time",
                "alias": "request_time",
                "output_type": "string",
                "default_value": None,
            },
...
EXPECTED_JSON_PATH_SEPARATOR = {
    "clean_rules": [
        ...
        },
        {
            "input_id": "json_data",
            "output_id": "path",
            "operator": {"type": "get", "key_index": [{"type": "key", "value": "filename"}], "missing_strategy": None},
        },
        {
            "input_id": "path",
            "output_id": "bk_separator_object_path",
            "operator": {"type": "regex", "regex": "/data/logs/(?P<app_name>[^/]+)/(?P<log_type>[^/]+)\\.log"},
        },
        {
