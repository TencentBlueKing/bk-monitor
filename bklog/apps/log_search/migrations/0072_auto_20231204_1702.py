# Generated by Django 3.2.15 on 2023-12-04 09:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='UserIndexSetSearchOptionHistory',
            fields=[
                ...
                (
                    'index_set_type',
                    models.CharField(
                        choices=[('single', '单索引集'), ('union', '联合索引集')],
                        default='single',
                        max_length=32,
                        verbose_name='索引集类型',
                    ),
            ...
            options={
                'verbose_name': '索引集用户检索选项记录',
                'verbose_name_plural': '34_搜索-索引集用户检索选项记录',
                'ordering': ('-updated_at',),
            },
        ),
        migrations.AddField(
