...
from apps.log_commons.exceptions import TokenExpiredException, TokenValidatedException
...
ShareAuthMap = {
    # 日志检索
    "search": [{"action": ActionEnum.SEARCH_LOG, "resource": ResourceEnum.INDICES, "instance_id": "index_set_id"}]
}
