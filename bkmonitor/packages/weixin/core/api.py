...
class QyWeiXinApi(ApiMixin):
    ...
    # 企业微信：获取access_token
    QY_WEIXIN_GET_ACCESS_TOKEN_URL = weixin_settings.WEIXIN_QY_DOMAIN + '/cgi-bin/gettoken'
    # 企业微信：获取访问用户身份
    QY_WEIXIN_GET_USER_INFO_URL = weixin_settings.WEIXIN_QY_DOMAIN + "/cgi-bin/user/getuserinfo"
    # 企业微信：读取成员
    QY_WEIXIN_GET_USER_URL = weixin_settings.WEIXIN_QY_DOMAIN + "/cgi-bin/user/get"
    # 企业微信userid -> 微信openid
    QY_WEIXIN_CONVERT_TO_OPENID = weixin_settings.WEIXIN_QY_DOMAIN + "/cgi-bin/user/convert_to_openid"
