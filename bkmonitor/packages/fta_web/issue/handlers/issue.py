    ...
    def get_search_object(
        ...
        **kwargs,
        ...
        if self.bk_biz_ids:
            ...
            for biz_id in self.bk_biz_ids:
                exclude_ids.update(IssueMergeResolver.get_active_member_ids(biz_id))
            if exclude_ids:
                search_object = search_object.exclude("terms", _id=list(exclude_ids))
