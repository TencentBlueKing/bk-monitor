...
from bkmonitor.utils.alert_drilling import clean_where_conditions, ensure_histogram_quantile_include_le_dimension
    ...
    class RequestSerializer(serializers.Serializer):
        class QueryConfigSerializer(serializers.Serializer):
            ...
            def validate(self, attrs: dict) -> dict:
                ...
                ensure_histogram_quantile_include_le_dimension(attrs)
