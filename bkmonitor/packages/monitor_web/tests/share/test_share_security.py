...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("monitor_web.performance.views", "HostMetricSnapshotViewSet", "create"),
        ("monitor_web.performance.views", "HostMetricSnapshotViewSet", "retrieve"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("monitor_web.performance.views", "HostMetricSnapshotViewSet", "list"),
        ("monitor_web.performance.views", "HostMetricSnapshotViewSet", "update"),
