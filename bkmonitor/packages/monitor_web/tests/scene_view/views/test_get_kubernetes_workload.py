        ...
        expect = [
            ...
            {"key": "label_list", "name": "标签", "type": "kv", "value": []},
            {
                ...
                "value": {
                    "target": "blank",
                    "url": (
                        '?bizId=2#/k8s-new?cluster=BCS-K8S-00000&filterBy={"workload": ["bcs-cluster-manager"]}'
            ...
            },
            {
                ...
                "value": {
                    ...
                    "url": (
                        '?bizId=2#/k8s-new?cluster=BCS-K8S-00000&filterBy={"workload": ["bcs-cluster-manager"]}'
                        '&groupBy=["namespace", "container"]&sceneId=kubernetes&scene=performance&activeTab=list'
                    ),
                    "value": 0,
                },
            },
        ...
        expect = [
            {"key": "name", "name": "工作负载名称", "type": "string", "value": "bcs-cluster-manager"},
            {
                ...
                "value": {
                    "target": "blank",
                    "url": (
                        '?bizId=-3#/k8s-new?cluster=BCS-K8S-00002&filterBy={}&groupBy=["namespace"]'
                        "&sceneId=kubernetes&scene=performance&activeTab=list"
                    ),
                    "value": "BCS-K8S-00002",
                },
            ...
            {"key": "label_list", "name": "标签", "type": "kv", "value": []},
            {
                ...
                "value": {
                    "target": "blank",
                    "url": (
                        '?bizId=-3#/k8s-new?cluster=BCS-K8S-00002&filterBy={"workload": ["bcs-cluster-manager"]}'
                        '&groupBy=["namespace", "pod"]&sceneId=kubernetes&scene=performance&activeTab=list'
                    ),
                    "value": 1,
                },
