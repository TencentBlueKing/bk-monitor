...
SYSTEM_EVENT_MOCK_DATA = [
    # OOM Event
    {
        "dimensions.bk_biz_id": "2",
        "dimensions.bk_cloud_id": "0",
        "dimensions.bk_target_cloud_id": "0",
        "dimensions.bk_target_ip": "127.0.0.1",
        "dimensions.constraint": "CONSTRAINT_MEMCG",
        "dimensions.ip": "127.0.0.1",
        "dimensions.message": "系统发生OOM异常事件",
        "dimensions.oom_memcg": "/kubepods.slice/kubepods-burstable.slice/kubepods-burstable-po.slice",
        "dimensions.process": "gunicorn",
        "dimensions.task": "gunicorn",
        "dimensions.task_memcg": "/pods.slice/pods-burstable.slice/pods-burstable-pod1",
        "event.content": "oom",
        "event_name": "OOM",
        "target": "127.0.0.1",
        "_meta": {
            ...
            "__doc_id": "xxx",
            "__index": "xxx",
            "__result_table": "gse_system_event",
            "_time_": 1741746312000,
        },
    },
    # Disk Full Event
    {
        ...
        "dimensions.bk_target_ip": "127.0.0.1",
        "dimensions.disk": "/",
        "dimensions.file_system": "/dev/vda1",
        "dimensions.fstype": "ext4",
        "dimensions.ip": "127.0.0.1",
        "event.content": "disk_full",
        "event_name": "DiskFull",
        "target": "0:127.0.0.1",
        "time": "1741746312000",
        "_meta": {
    ...
    # Core File Event
    {
        ...
        "dimensions.bk_target_cloud_id": "0",
        "dimensions.bk_target_ip": "127.0.0.1",
        "dimensions.corefile": "/data/corefile/core_deepflow-agent",
        "dimensions.executable": "deepflow-agent",
        "dimensions.executable_path": "",
        "dimensions.filesize": "0",
        "dimensions.ip": "127.0.0.1",
        "dimensions.signal": "",
        "event.content": "process deepflow-agent create corefile at /data/corefile/core_deepflow-agent",
        "event_name": "CoreFile",
        "target": "0:127.0.0.1",
        "time": "1741700416000",
        "_meta": {
    ...
    # Agent Lost Event
    {
        "dimensions.bk_agent_id": "010000525400b4408316717021678103",
        "dimensions.bk_biz_id": "2",
        "dimensions.bk_cloud_id": "2",
        "dimensions.bk_target_cloud_id": "2",
        "dimensions.bk_target_ip": "127.0.0.1",
        "dimensions.ip": "127.0.0.1",
        "event.content": "AgentLost",
        "event_name": "AgentLost",
        "target": "01000052678103",
        "time": "1739550526000",
        "_meta": {
            "__data_label": "system_event",
            "__doc_id": "xxx",
    ...
    # Disk Read-Only Event
    {
        "dimensions.bk_biz_id": "2",
        "dimensions.bk_cloud_id": "0",
        "dimensions.bk_target_cloud_id": "0",
        "dimensions.bk_target_ip": "127.0.0.1",
        "dimensions.position": "/dev/v",
        "dimensions.fs": "ext4",
        "dimensions.ip": "127.0.0.1",
        "dimensions.type": "xxxx",
        "event.content": "disk_full",
