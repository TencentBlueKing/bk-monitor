...
class MetricName(LabelMixin, CachedEnum):
    ...
    BCS_PERFORMANCE_CPU_REQUEST_USAGE_RATE = f"{MetricTypePrefix.BCS}.{BCSMetricName.PERFORMANCE_CPU_REQUEST_USAGE_RATE}"
    ...
    BCS_PERFORMANCE_MEMORY_REQUEST_USAGE_RATE = f"{MetricTypePrefix.BCS}.{BCSMetricName.PERFORMANCE_MEMORY_REQUEST_USAGE_RATE}"
    BCS_PERFORMANCE_MEMORY_LIMIT_USAGE_RATE = f"{MetricTypePrefix.BCS}.{BCSMetricName.PERFORMANCE_MEMORY_LIMIT_USAGE_RATE}"
