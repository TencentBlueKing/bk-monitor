...
class GrafanaViewSet(ResourceViewSet):
    ...
    resource_routes = [
        ...
        # Trace panel
        ResourceRoute("POST", resource.apm_web.list_application_info, endpoint="apm/list_application_info"),
        ResourceRoute("POST", resource.apm_web.get_field_option_values, endpoint="apm/get_field_option_values"),
        ResourceRoute("POST", resource.apm_web.grafana_list_trace, endpoint="apm/list_trace"),
        ResourceRoute("POST", resource.apm_web.grafana_trace_detail, endpoint="apm/trace_detail"),
    ]
