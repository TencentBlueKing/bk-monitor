    ...
    def dashboards(self, request, org_name: str, org_id: int):
        ...
        if settings.BCS_API_GATEWAY_HOST:
            grafana_default_dashboard_name += [
                ...
                "Application-SQL_Monitoring-Cloud",
                "Applicaton-Dubbo-Monitoring-K8S",
                "Capacity-Estimation",
                ...
                "DeepFlow-Resource",
                "DeepFlow-Server",
                "DeepFlow-Server-Controller",
                "DeepFlow-Server-Controller-Prometheus",
                "DeepFlow-Server-Ingester",
                "DeepFlow-Server-Ingester-Prometheus",
                "DeepFlow-Server-Querier",
                "Distributed-Tracing",
