        ...
        items.append(
            {
                ...
                "functions": copy.deepcopy(item.get("functions", [])),
                "metric_type": item["query_configs"][0]["data_type_label"],
                "query_configs": copy.deepcopy(item["query_configs"]),
                "algorithms": copy.deepcopy(item["algorithms"]),
            }
        )
    return {
        "name": generated["name"],
