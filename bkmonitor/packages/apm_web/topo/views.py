...
from apm_web.decorators import user_visit_record_for_topo
...
class GlobalViewSet(ResourceViewSet):
    ...
    resource_routes = [
        ...
        ResourceRoute("GET", TopoViewResource, endpoint="topo",decorators=[user_visit_record_for_topo,],),  # 添加topo_view接口的访问记录
