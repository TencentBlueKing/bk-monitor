...
class NodeManV3Resource(APIResource):
    ...
    @property
    def base_url(self):
        if not settings.BKNODEMAN_CONTROL_API_BASE_URL:
            raise ValueError("BKNODEMAN_CONTROL_API_BASE_URL must be configured")
        return settings.BKNODEMAN_CONTROL_API_BASE_URL
