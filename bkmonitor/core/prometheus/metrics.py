...
COMMANDS_DURATION_SECONDS_TOTAL = Gauge(
    ...
    labelnames=("node_type", "mastername", "role", "cmd", "host", "port"),
)
...
DB_AVG_TTL_SECONDS = Gauge(
    ...
    labelnames=("node_type", "mastername", "role", "db", "host", "port"),
)
...
EXPORTER_BUILD_INFO = Gauge(
    ...
    labelnames=("node_type", "mastername", "role", "commit_sha", "version", "build_date", "host", "port"),
)
...
EXPORTER_LAST_SCRAPE_ERROR = Gauge(
    ...
    labelnames=("node_type", "mastername", "role", "err", "host", "port"),
)
