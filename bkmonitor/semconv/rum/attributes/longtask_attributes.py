...
LONG_TASK_SCRIPT_SOURCE_URL = FieldSpec(field_name="long_task.script.source_url", field_alias=_("已脱敏的脚本 URL"))
...
LONG_TASK_ENTRY_TYPE = FieldSpec(field_name="long_task.entry_type", field_alias=_("采集条目类型"))
