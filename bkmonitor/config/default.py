...
# 支持暂停自定义指标下发
DISABLE_REFRESH_CUSTOM_REPORT_NODE_MAN_METRIC = (
    os.getenv("DISABLE_REFRESH_CUSTOM_REPORT_NODE_MAN_METRIC", "false").lower() == "true"
)
DISABLE_REFRESH_CUSTOM_REPORT_K8S_METRIC = (
    os.getenv("DISABLE_REFRESH_CUSTOM_REPORT_K8S_METRIC", "false").lower() == "true"
)
