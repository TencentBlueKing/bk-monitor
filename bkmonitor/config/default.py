...
# Independent MCP permission first; only explicit denial checks the SaaS permission.
...
BKFARA_AIOPS_SERVICE_DEFAULT_RESOURCE_NAME = os.getenv("BKFARA_AIOPS_SERVICE_DEFAULT_RESOURCE_NAME", "")
