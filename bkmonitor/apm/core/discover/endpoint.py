...
class EndpointDiscover(DiscoverBase):
    ...
    def query_cache_and_instance_data(self):
        cache_name = FieldCacheHandler.get_endpoint_cache_key(self.bk_biz_id, self.app_name)
        cache_data = FieldCacheHandler().get_cache_data(cache_name)
    ...
    def refresh_cache_data(
        ...
        name = FieldCacheHandler.get_endpoint_cache_key(self.bk_biz_id, self.app_name)
