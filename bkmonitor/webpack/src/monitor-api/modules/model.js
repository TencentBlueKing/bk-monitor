...
export default {
  countBaseAlarm,listBaseAlarm,retrieveBaseAlarm,countSnapshotHostIndex,listSnapshotHostIndex,retrieveSnapshotHostIndex,countUserConfig,createUserConfig,destroyUserConfig,listUserConfig,partialUpdateUserConfig,retrieveUserConfig,updateUserConfig,countApplicationConfig,createApplicationConfig,destroyApplicationConfig,listApplicationConfig,partialUpdateApplicationConfig,retrieveApplicationConfig,updateApplicationConfig,countGlobalConfig,listGlobalConfig,retrieveGlobalConfig,listAlarmType,countUptimeCheckNode,createUptimeCheckNode,destroyUptimeCheckNode,fixNameConflictUptimeCheckNode,isExistUptimeCheckNode,listUptimeCheckNode,partialUpdateUptimeCheckNode,retrieveUptimeCheckNode,updateUptimeCheckNode,changeStatusUptimeCheckTask,cloneUptimeCheckTask,countUptimeCheckTask,createUptimeCheckTask,deployUptimeCheckTask,destroyUptimeCheckTask,listUptimeCheckTask,partialUpdateUptimeCheckTask,retrieveUptimeCheckTask,runningStatusUptimeCheckTask,testUptimeCheckTask,updateUptimeCheckTask,addTaskUptimeCheckGroup,createUptimeCheckGroup,destroyUptimeCheckGroup,listUptimeCheckGroup,partialUpdateUptimeCheckGroup,retrieveUptimeCheckGroup,updateUptimeCheckGroup,checkIdCollectorPlugin,createCollectorPlugin,deleteCollectorPlugin,destroyCollectorPlugin,editCollectorPlugin,exportPluginCollectorPlugin,fetchDebugLogCollectorPlugin,importPluginCollectorPlugin,listCollectorPlugin,operatorSystemCollectorPlugin,partialUpdateCollectorPlugin,pluginImportWithoutFrontendCollectorPlugin,releaseCollectorPlugin,replacePluginCollectorPlugin,retrieveCollectorPlugin,startDebugCollectorPlugin,stopDebugCollectorPlugin,tagOptionsCollectorPlugin,updateCollectorPlugin,uploadFileCollectorPlugin,batchDeleteIpChooserConfig,batchGetIpChooserConfig,globalConfigIpChooserConfig,updateConfigIpChooserConfig,checkIpChooserHost,detailsIpChooserHost,detailsIpChooserServiceInstance,agentStatisticsIpChooserTemplate,hostsIpChooserTemplate,nodesIpChooserTemplate,serviceInstanceCountIpChooserTemplate,templatesIpChooserTemplate,agentStatisticsIpChooserTopo,queryHostIdInfosIpChooserTopo,queryHostsIpChooserTopo,queryPathIpChooserTopo,queryServiceInstancesIpChooserTopo,serviceInstanceCountIpChooserTopo,treesIpChooserTopo,enhancedContext,listUsersUser,createFavoriteGroup,destroyFavoriteGroup,listFavoriteGroup,partialUpdateFavoriteGroup,retrieveFavoriteGroup,updateFavoriteGroup,updateGroupOrderFavoriteGroup,bulkDeleteFavorite,bulkUpdateFavorite,createFavorite,destroyFavorite,listFavorite,listByGroupFavorite,partialUpdateFavorite,retrieveFavorite,shareFavorite,updateFavorite,createQueryHistory,destroyQueryHistory,listQueryHistory,partialUpdateQueryHistory,retrieveQueryHistory,updateQueryHistory,createUserGroup,destroyUserGroup,listUserGroup,partialUpdateUserGroup,retrieveUserGroup,updateUserGroup,createDutyRule,destroyDutyRule,listDutyRule,partialUpdateDutyRule,retrieveDutyRule,switchDutyRule,updateDutyRule,createActionConfig,destroyActionConfig,listActionConfig,partialUpdateActionConfig,retrieveActionConfig,updateActionConfig,createActionPluginCurd,destroyActionPluginCurd,listActionPluginCurd,partialUpdateActionPluginCurd,retrieveActionPluginCurd,updateActionPluginCurd,createSearchFavorite,destroySearchFavorite,listSearchFavorite,partialUpdateSearchFavorite,retrieveSearchFavorite,updateSearchFavorite,createAssignGroup,destroyAssignGroup,listAssignGroup,partialUpdateAssignGroup,retrieveAssignGroup,updateAssignGroup,createAssignRule,destroyAssignRule,listAssignRule,partialUpdateAssignRule,retrieveAssignRule,updateAssignRule,
};
