...
export default {
  collectConfigList,collectConfigDetail,toggleCollectConfigStatus,deleteCollectConfig,cloneCollectConfig,retryTargetNodes,revokeTargetNodes,batchRevokeTargetNodes,batchRetryConfig,saveCollectConfig,upgradeCollectPlugin,rollbackDeploymentConfig,frontendTargetStatusTopo,frontendCollectConfigDetail,collectInstanceStatus,collectTargetStatus,collectNodeStatus,getMetrics,renameCollectConfig,deploymentConfigDiff,collectRunningStatus,getCollectLogDetail,updateConfigInstanceCount,getCollectVariables,batchRetry,listLegacySubscription,cleanLegacySubscription,listLegacyStrategy,listRelatedStrategy,isTaskReady,checkAdjectiveCollect,fetchCollectConfigStat,checkPluginVersion,
};
