...
export default {
  getScene,getSceneView,getSceneViewList,updateSceneView,deleteSceneView,getSceneViewDimensions,getSceneViewDimensionValue,getStrategyAndEventCount,getHostProcessPortStatus,getHostOrTopoNodeDetail,getHostProcessUptime,getHostProcessList,getCustomMetricTargetList,getCustomEventTargetList,getUptimeCheckTaskList,getUptimeCheckTaskInfo,getUptimeCheckTaskData,getUptimeCheckVarList,getKubernetesClusterList,getKubernetesCluster,getKubernetesClusterChoices,getKubernetesUsageRatio,getKubernetesWorkloadCountByNamespace,getKubernetesPod,getKubernetesPodList,getKubernetesService,getKubernetesServiceList,getKubernetesContainer,getKubernetesContainerList,getKubernetesWorkload,getKubernetesWorkloadList,getKubernetesNode,getKubernetesNodeList,getKubernetesServiceMonitor,getKubernetesServiceMonitorList,getKubernetesServiceMonitorEndpoints,getKubernetesPodMonitor,getKubernetesPodMonitorList,getKubernetesPodMonitorEndpoints,getKubernetesEvents,getKubernetesWorkloadTypes,getKubernetesWorkloadStatusList,getKubernetesNamespaces,getKubernetesObjectCount,getKubernetesControlPlaneStatus,getKubernetesWorkloadStatus,getHostList,getHostInfo,getPluginCollectConfigIdList,getObservationSceneList,getObservationSceneStatusList,getPluginTargetTopo,getPluginInfoByResultTable,getKubernetesConsistencyCheck,getKubernetesServiceMonitorPanels,getKubernetesPodMonitorPanels,getKubernetesNetworkTimeSeries,getKubernetesPreAllocatableUsageRatio,getKubernetesEventCountByType,getKubernetesEventCountByEventName,getKubernetesEventCountByKind,getKubernetesEventTimeSeries,getKubernetesCpuAnalysis,getKubernetesMemoryAnalysis,getKubernetesDiskAnalysis,getKubernetesOverCommitAnalysis,getKubernetesNodeCpuUsage,getKubernetesNodeMemoryUsage,getKubernetesNodeDiskSpaceUsage,getKubernetesNodeDiskIoUsage,getIndexSetLogSeries,listIndexSetLog,
};
