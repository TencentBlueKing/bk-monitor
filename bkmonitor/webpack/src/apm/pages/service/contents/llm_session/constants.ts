...
/** 会话 / Trace 视角同步到路由 query 的参数名，刷新后依此还原当前 tab */
export const LLM_SESSION_TAB_QUERY_KEY = 'llm_session_tab';
...
export const PAGE_LIMIT = Math.floor(window.innerHeight / 45);
