...
const cacheJsName = 'external-cache-js-' + cacheVersion;
const cacheCssName = 'external-cache-css-' + cacheVersion;
const cacheFontName = 'external-cache-font-' + cacheVersion;
const cacheImgName = 'external-cache-img-' + cacheVersion;
const cacheApiName = 'external-cache-api-' + cacheVersion;
const cacheList = [cacheJsName, cacheCssName, cacheFontName, cacheImgName];
const staticUrl = '${STATIC_URL}external/';
// const cacheApiFiles = [
//     '/rest/',
//     '/api/'
// ]
