...
class ActionProcessor(BaseActionProcessor):
    ...
    def __init__(self, action_id, alerts=None):
        ...
        self.max_retry_times = int(self.failed_retry.get("max_retry_times"))
        self.retry_interval = int(self.failed_retry.get("retry_interval"))
    ...
    def webhook_request(self):
        ...
        try:
            r = requests.request(
                ...
                timeout=int(self.failed_retry["timeout"]),
                auth=self.auth,
                verify=False,
            )
