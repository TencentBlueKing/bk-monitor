    ...
    def pre_detect(self, data_points: List[DataPoint]) -> None:
        ...
        for data_point in data_points:
            ...
            if dimension_md5 not in predict_inputs:
                ...
                predict_inputs["dimensions"]["strategy_id"] = data_point.item.strategy.id

            predict_inputs[dimension_md5].append(
                {
        ...
        predict_params = {
            ...
            "interval": data_point[0].item.query_configs[0]["agg_interval"],
            "predict_args": {
