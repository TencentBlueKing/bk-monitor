...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        tenant_id = DataSource.objects.get(bk_data_id=data_id).bk_tenant_id
        ...
        client.push_table_id_detail(table_id_list=[ts_group.table_id], is_publish=True, bk_tenant_id=tenant_id)
