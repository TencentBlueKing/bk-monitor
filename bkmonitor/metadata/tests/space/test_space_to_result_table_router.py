...
def test_push_space_to_rt_router_for_bkcc(create_or_delete_records):
    ...
    with patch("metadata.utils.redis_tools.RedisTools.hmset_to_redis") as mock_hmset_to_redis:
        with patch("metadata.utils.redis_tools.RedisTools.publish") as mock_publish:
            ...
            expected = '{"system|1001_bklog.stdout":{"filters":[{"bk_biz_id":"1"}]},"system|1001_bkmonitor_time_series_50010.__default__":{"filters":[{"dimensions.bk_biz_id":"1"}]},"system|bkm_1_record_rule.__default__":{"filters":[]}}'
...
def test_push_space_to_rt_router_for_bkci(create_or_delete_records):
    ...
    with patch("metadata.utils.redis_tools.RedisTools.hmset_to_redis") as mock_hmset_to_redis:
        with patch("metadata.utils.redis_tools.RedisTools.publish") as mock_publish:
            ...
            expected = '{"system|custom_report_aggate.base":{"filters":[{"dimensions.bk_biz_id":"-10000"}]},"system|bkm_statistics.base":{"filters":[{"bk_biz_id":"-10000"}]},"system|apm_global.precalculate_storage_1":{"filters":[{"biz_id":"-10000"}]},"system|apm_global.precalculate_storage_2":{"filters":[{"biz_id":"-10000"}]},"system|apm_global.precalculate_storage_3":{"filters":[{"biz_id":"-10000"}]}}'
...
def test_push_space_to_rt_router_for_bksaas(create_or_delete_records):
    ...
    with patch("metadata.utils.redis_tools.RedisTools.hmset_to_redis") as mock_hmset_to_redis:
        with patch("metadata.utils.redis_tools.RedisTools.publish") as mock_publish:
            ...
            expected = '{"system|custom_report_aggate.base":{"filters":[{"bk_biz_id":"-10008"}]},"system|bkm_statistics.base":{"filters":[{"dimensions.bk_biz_id":"-10008"}]},"system|apm_global.precalculate_storage_1":{"filters":[{"biz_id":"-10008"}]},"system|apm_global.precalculate_storage_2":{"filters":[{"biz_id":"-10008"}]},"system|apm_global.precalculate_storage_3":{"filters":[{"biz_id":"-10008"}]}}'
