...
def test_compose_bcs_federal_subset_time_series_configs(create_or_delete_records):
    ...
    # 测试参数是否正确组装
    bkbase_data_name = utils.compose_bkdata_data_id_name(sub_ds.data_name)
    assert bkbase_data_name == "bkm_bcs_BCS-K8S-10002_k8s_metric"
    ...
    content = data_link_ins.compose_configs(
        data_source=sub_ds, table_id=sub_rt.table_id, bcs_cluster_id='BCS-K8S-10002'
    )
