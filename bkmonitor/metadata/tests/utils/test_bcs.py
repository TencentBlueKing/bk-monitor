...
from metadata.utils.bcs import get_bcs_dataids, get_bcs_space_by_biz
...
def create_or_delete_records():
    ...
    bcs_cluster_infos = [
        models.BCSClusterInfo(
            cluster_id="BCS-K8S-00000", port=1, bk_biz_id=1, CustomMetricDataID=1001, K8sMetricDataID=1002
        ),
        models.BCSClusterInfo(
            cluster_id="BCS-K8S-00001", port=1, bk_biz_id=2, CustomMetricDataID=1003, K8sMetricDataID=1004
        ),
        models.BCSClusterInfo(
            cluster_id="BCS-K8S-00002", port=1, bk_biz_id=3, CustomMetricDataID=1005, K8sMetricDataID=1006
        ),
    ]
...
def test_get_bcs_dataids(create_or_delete_records):
    ...
    assert data_id_cluster_map == {
        1001: "BCS-K8S-00000",
        1002: "BCS-K8S-00000",
        1003: "BCS-K8S-00001",
        "built_in_metric_data_id_list": [1002],
    }
