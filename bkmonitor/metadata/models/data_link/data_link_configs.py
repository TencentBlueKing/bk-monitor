...
a = {
    "test-env-es": ["amg-test-env-log1"],
    "auto_cluster_name_146": ["bcslog-common-gz-1"],
    "auto_cluster_name_148": ["bk-apigateway"],
    "auto_cluster_name_326": ["bk-trace-sz-02"],
    "auto_cluster_name_162521": ["bk-trace-sz-03", "bklog_es_162521"],
    "auto_cluster_name_267": ["bklog-tiyan02"],
    "bkdevops_ms_es": ["bklog_es_128"],
    "auto_cluster_name_162436": ["bklog_es_162436"],
    "auto_cluster_name_162448": ["bklog_es_162448"],
    "lszz-product-es": ["bklog_es_162451"],
    "bklog-pub4": ["bklog_es_162553"],
    "auto_cluster_name_288": ["bklog_es_288"],
    "uc-bk-logs1": ["bklog_es_289"],
    "auto_cluster_name_230": ["bnsneo-log"],
    "logsearch": ["cmk-es-logsearch"],
    "apm": ["cmk_apm"],
    "auto_cluster_name_296": ["codepanda-bk-logs1"],
    "pub_bklog1": ["codev-bklog-pub1"],
    "pub_bklog2": ["codev-bklog-pub2"],
    "pub_bklog3": ["codev-bklog-pub3"],
    "bklog1": ["codev-bklog1"],
    "DBM_ES": ["dbm-logs1"],
    "auto_cluster_name_338": ["dhm1-logs1"],
    "dhrs-es-bk-logs1": ["dhrs-bk-logs1"],
    "es-test": ["dragon-cn-testlog-lxsj"],
    "es-obt": ["es-obt-lxsj"],
    "auto_cluster_name_281": ["ffm-logs1"],
    "test-service": ["gameairel-bk-logs1"],
    "auto_cluster_name_327": ["gvoice-logs1"],
    "auto_cluster_name_282": ["hpjyzs"],
    "auto_cluster_name_314": ["jddts-bk-logs1"],
    "apm-logs1": ["kihan-apm-logs1"],
    "kihan_es_5": ["kihanes5"],
    "kihan_es_6": ["kihanes6"],
    "kihan_es_7": ["kihanes7"],
    "warm-round": ["lgame-warm-round"],
    "auto_cluster_name_245": ["mj-bcs-bklog"],
    "monha-es-bk-logs1": ["monha-bk-logs1"],
    "nba2021": ["nba2021-bklogs1"],
    "nbn": ["nbn-bk-logs1"],
    "NBN-ES": ["nbn-bk-logs2"],
    "es-nishiki-log": ["nishikicn-bk-logs1"],
    "auto_cluster_name_256": ["np_log"],
    "pracinges-nj": ["pracinges-nj-logs1"],
    "auto_cluster_name_279": ["public-bk-logs1"],
    "auto_cluster_name_333": ["sap-bk-logs1"],
    "auto_cluster_name_287": ["sgame-new-log-4"],
    "auto_cluster_name_292": ["sworld-logs1"],
    "auto_cluster_name_165": ["tyscyrjlogs"],
    "uamobile": ["uamobile-bk-logs1"],
    "skywalking-es": ["vip-skywalking-es"],
    "ymzx_apm_es": ["ymzx-apm-es"],
    "auto_cluster_name_320": ["yxsxyx-bk-logs1"],
    "auto_cluster_name_162659": ["public-bk-logs3"],
    "auto_cluster_name_161": ["bcslog-common-gz-2"],
    "auto_cluster_name_12": [],
    "auto_cluster_name_119": [],
    "codm_log_es": [],
    "lgame-cmdlog": [],
    "lgame-cn": [],
    "auto_cluster_name_7": [],
    "auto_cluster_name_m9S3Pm8nnHErJAaH": [],
    "es_kibana_example1": [],
    "fcm-loadtest": [],
    "auto_cluster_name_85": [],
    "auto_cluster_name_184": [],
    "es_monitor_alert": [],
    "zhijilab-kg-es": [],
    "cfmalllog": [],
    "auto_cluster_name_100": [],
    "HGame": [],
    "BkAuditES": [],
    "agame-sz-es1": [],
    "xinyue-apm-es": [],
    ...
    "bklog": [],
    "taris-logsdata": [],
    "auto_cluster_name_208": [],
    "auto_cluster_name_209": [],
    "lollogsk8s": [],
    "stag_test": [],
    "jhxjy-global-logs": [],
    "weixiang-es": [],
    ...
    "redes2": [],
    "bk-saas-bybklog-2": [],
    "projectg-default-bklog-es": [],
    "nrc-es1": [],
    "auto_cluster_name_259": [],
    "auto_cluster_name_260": [],
    "redes3": [],
    "auto_cluster_name_305": [],
    "es-shanghai-5": [],
    "eks-cls-es": [],
    "es": [],
    "NBA2_es_log": [],
    "ingame_log_es": [],
    "auto_cluster_name_255": [],
    "yfsail-log": [],
    "pqsn_dbm_es": [],
    "soch-logs01": [],
    "redes4": [],
    ...
    "bk-saas-bybklog-3": [],
    "poe-bk-logs1": [],
    "auto_cluster_name_162493": [],
    "bklog-prod": [],
    "nqf-es1": [],
    "zzjz-bklog": [],
    "rmcn-bk-logs1": [],
    "auto_cluster_name_162564": [],
    "auto_cluster_name_162566": [],
    "kihan_es_8": [],
    "tf-logs-es": [],
    "bcs-audit": [],
    "bk-event2": [],
    ...
    "es-life-bk-logs1": [],
    "bkaidev-apm1": [],
    "auto_cluster_name_NUxlDRlFKgjNoNjv": [],
    "auto_cluster_name_216": [],
    "auto_cluster_name_8": [],
    "auto_cluster_name_9": [],
    "auto_cluster_name_13": [],
    "guangzhou": [],
    "welink-sandbox": [],
    "WELINK-HRDX": [],
    "welink-cloudcenter-new": [],
    "auto_cluster_name_39": [],
    "LOL_ES": [],
    "yxsq_es_new": [],
    "auto_cluster_name_28": [],
    "auto_cluster_name_29": [],
    "qqdancer_serverlog": [],
    "wxshproductnew": [],
    "cfhdcluster2": [],
    "dnflog-es-cluster": [],
    "auto_cluster_name_50": [],
    "cfmlog": [],
    "dnf-log-es-test": [],
    "dnf-log-es-exp": [],
    "wstsvrlog_es_cluster": [],
    "cf_es_clouster_standalone": [],
    "auto_cluster_name_77": [],
    "FMGAME": [],
    "auto_cluster_name_102": [],
    "auto_cluster_name_150": [],
}
