...
class TestGetMcpPermissionActionByServerName:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("bk-monitor-prod-log-scene-search", "using_log_mcp"),
            ("bk-monitor-prod-log-extract", "using_log_extract_mcp"),
            ("bk-monitor-prod-log-collection", "using_log_collection_mcp"),
