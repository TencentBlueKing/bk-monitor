...
ADVANCED_OPTIONS = OrderedDict(
    [
        ...
        ("BKBASE_REDIS_TASK_MAX_EXECUTION_TIME_SECONDS", slz.IntegerField(label="计算平台Redis任务最大执行时间(秒)", default=86400)),
        ...
        ("ENABLE_SYNC_HISTORY_ES_CLUSTER_RECORD_FROM_BKBASE", slz.BooleanField(label="是否启用同步历史ES集群记录能力", default=True)),
