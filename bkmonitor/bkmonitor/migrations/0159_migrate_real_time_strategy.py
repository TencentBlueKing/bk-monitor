# Generated by Django 3.2.15 on 2024-03-12 02:51
...
def migrate_real_time_strategy(apps, schema_editor):
    ...
    try:
        ...
        for qc in query_configs:
            ...
            if data_source_label in [DataSourceLabel.CUSTOM] and bool(re.search(r'_\d+$', result_table_id)) and data_label:
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(migrate_real_time_strategy),
    ]
