# Generated migration for StrategyIssueConfig
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "strategy_id",
                    models.IntegerField(db_index=True, unique=True, verbose_name="策略 ID"),
                ),
                ...
                (
                    "conditions",
                    bkmonitor.utils.db.fields.JsonField(default=list, verbose_name="过滤条件"),
                ),
                (
                    "alert_levels",
                    bkmonitor.utils.db.fields.JsonField(default=list, verbose_name="生效告警级别"),
                ),
            ],
            options={
