...
本目录由 `bk-monitor` 主仓直接维护，不再作为独立 Git 仓库或 Git submodule。
保留独立的 Python 包、依赖声明和测试目录，代码改动在主仓统一提交和评审。
迁入基线为原主仓固定的 Base 提交 `7a6e1b3ee4dbcf4907ca18bf4041ec1daa3ebf68`。
