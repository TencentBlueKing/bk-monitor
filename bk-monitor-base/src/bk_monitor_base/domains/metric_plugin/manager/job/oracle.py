...
@final
class OraclePluginManager(SQLPluginManager):
    """
    Oracle Job插件管理器

    Repo 必须包含以下文件:
    - job_plugin/job_oracle/OracleUniversalPlugin (Linux X86_64)
    - job_plugin/job_oracle/OracleUniversalPlugin_arm (Linux AARCH64)
    """

    type: ClassVar[str] = "job_oracle"
    DB_TYPE: ClassVar[str] = "oracle"
