...
from bk_monitor_base.domains.collector.define.declaratives.enums import CollectSetTaskStatus, CollectType
from bk_monitor_base.domains.collector.define.declaratives.enums.collect import ReconcileStatus
...
class CollectSetMetadata(Metadata):
    ...
    labels: CollectSetLabels = Field(default_factory=CollectSetLabels.default)  # pyright: ignore[reportAssignmentType]
