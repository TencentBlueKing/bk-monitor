    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "level",
                    models.IntegerField(
                        choices=[(1, "致命"), (2, "预警"), (3, "提醒")], default=3, verbose_name="告警级别"
                    ),
                ),
                (
                    "type",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "no_data_config",
                    models.JSONField(
                        default=bk_monitor_base.domains.strategy.models._no_data_config, verbose_name="无数据配置"
                    ),
                ),
                (
                    "target",
                    models.JSONField(
                        default=bk_monitor_base.domains.strategy.models._default_target, verbose_name="监控目标"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "priority_group_key",
                    models.CharField(blank=True, default=None, max_length=64, null=True, verbose_name="优先级分组"),
                ),
            ],
            options={
                "verbose_name": "策略配置V2",
                ...
                "managed": True,
                "indexes": [
                    models.Index(fields=["is_enabled", "bk_biz_id", "scenario"], name="alarm_strat_is_enab_202cd6_idx")
                ],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "managed": True,
                "indexes": [
                    models.Index(fields=["data_source_label", "data_type_label"], name="alarm_query_data_so_594385_idx")
                ],
            },
        ),
    ]
