...
from bk_monitor_base.metadata.models.vm.utils import access_v2_bkdata_vm
from bk_monitor_base.metadata.service.data_source import modify_data_id_source
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        bk_biz_id = options.get("bk_biz_id", settings.metadata.default_bkdata_biz_id)
    ...
    def compose_data_id_config(self, data_id_ins, datasource, kafka_name) -> dict:
        ...
        return utils.compose_config(
            ...
            render_params={
                ...
                "monitor_biz_id": settings.metadata.default_bkdata_biz_id,  # 接入者的业务ID
