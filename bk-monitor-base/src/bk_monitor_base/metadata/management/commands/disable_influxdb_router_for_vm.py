...
from bk_monitor_base.metadata.service.vm_storage import disable_influxdb_router_for_vm_table
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--check_table_ids", type=bool, default=False, help="校验要删除的结果表，设置为True，则仅输出要删的结果表"
        )
