...
from bk_monitor_base.metadata.service.storage_details import StorageClusterDetail
from bk_monitor_base.metadata.utils.request import get_app_code_by_request, get_request
...
class CreateClusterInfoResource(Resource):
    ...
    @override
    def perform_request(self, validated_request_data: dict[str, Any]) -> int:
        # 获取请求来源系统
        request = get_request()
...
class ModifyClusterInfoResource(Resource):
    ...
    def perform_request(self, validated_request_data: dict[str, Any]) -> dict[str, Any]:
        ...
        cluster_id: int | None = validated_request_data.pop("cluster_id", None)
        cluster_name: str | None = validated_request_data.pop("cluster_name", None)
