...
from bk_monitor_base.metadata.models import EntityMeta
from bk_monitor_base.metadata.models.entity_relation import NAMESPACE_ALL
...
class EntityHandlerFactory:
    ...
    def get_handler(cls, kind: str) -> EntityHandler:
        ...
        if not model_class:
            raise Exception(f"Unsupported entity kind: {kind}")
