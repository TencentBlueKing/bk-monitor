...
from bk_monitor_base.metadata.service.vm_storage import (
...
class CreateVmCluster(Resource):
    ...
    def perform_request(self, validated_request_data: dict[str, Any]) -> dict:
        ...
        with atomic(config.DATABASE_CONNECTION_NAME):
            ...
            # 刷新空间使用的 vm 集群
            # NOTE: 注意排除掉使用特定集群的空间
            models.SpaceVMInfo.objects.exclude(space_id__in=settings.metadata.single_vm_space_id_list).update(
