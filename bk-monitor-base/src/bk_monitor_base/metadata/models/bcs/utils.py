...
def is_equal_config(source: dict[str, Any], target: dict[str, Any]) -> bool:
    """
    判断传入的config与当前是否相同
    """
...
def ensure_data_id_resource(api_client: k8s_client.ApiClient, resource_name: str, config_data: dict[str, Any]) -> bool:
    """
