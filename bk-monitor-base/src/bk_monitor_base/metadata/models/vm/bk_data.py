...
from bk_monitor_base.metadata.models.vm.config import BkDataClean, BkDataStorage
...
class BkDataAccessor:
    ...
    def create(self) -> dict[str, Any]:
        ...
        try:
            return api.bkdata.create_data_hub(bk_tenant_id=DEFAULT_TENANT_ID, **params)
