...
from bk_monitor_base.metadata.models.data_link import utils
...
from bk_monitor_base.metadata.models.data_link.data_link_configs import (
...
from bk_monitor_base.metadata.models.data_link.utils import (
    generate_result_table_field_list,
    get_bkbase_raw_data_id_name,
)
from bk_monitor_base.metadata.models.storage import ClusterInfo, DorisStorage, ESStorage

if TYPE_CHECKING:
    from bk_monitor_base.metadata.models import DataSource
    from bk_monitor_base.metadata.models.data_link.data_link_configs import DataLinkResourceConfigBase
...
class DataLink(models.Model):
    ...
    namespace = models.CharField(
        max_length=255, verbose_name="命名空间", default=settings.metadata.default_vm_data_link_namespace
    )
    ...
    def compose_custom_event_configs(
        ...
        Args:
            ...
            table_id: 结果表ID
        """
        from bk_monitor_base.metadata.models import ResultTableOption
    ...
    def compose_log_configs(
        ...
        """
        from bk_monitor_base.metadata.models import ResultTableOption
        from bk_monitor_base.metadata.models.result_table import LogV4DataLinkOption
    ...
    def compose_bcs_federal_subset_time_series_configs(
        ...
        from bk_monitor_base.metadata.models.bcs import BcsFederalClusterInfo
    ...
    def compose_bk_plugin_time_series_config(
        ...
        """
        from bk_monitor_base.metadata.models import ResultTableField, ResultTableOption
            ...
            with transaction.atomic():
                BkBaseResultTable.objects.update_or_create(
                    ...
                    defaults={
                        ...
                        "bkbase_table_id": f"{settings.metadata.default_bkdata_biz_id}_{bkbase_vmrt_name}",
    ...
    def sync_basereport_metadata(self, bk_biz_id, storage_cluster_name, source, datasource):
        ...
        """
        from bk_monitor_base.metadata.models import AccessVMRecord, ClusterInfo
