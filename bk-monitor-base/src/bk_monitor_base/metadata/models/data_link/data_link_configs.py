...
from bk_monitor_base.infras.db_models.fields import SymmetricJSONField
from bk_monitor_base.metadata.config import settings
from bk_monitor_base.metadata.models.data_link import constants, utils
from bk_monitor_base.metadata.models.data_link.constants import (
    BKBASE_NAMESPACE_BK_LOG,
    BKBASE_NAMESPACE_BK_MONITOR,
    DataLinkKind,
)
from bk_monitor_base.metadata.models.space.constants import LOG_EVENT_ETL_CONFIGS
...
class DataLinkResourceConfigBase(models.Model):
    ...
    namespace = models.CharField(
        verbose_name="命名空间", max_length=64, default=settings.metadata.default_vm_data_link_namespace
    )
    ...
    def component_config(self):
        ...
        组件完整配置（bkbase侧）
        """
        from bk_monitor_base.metadata.models.data_link.service import get_data_link_component_config
...
class DataIdConfig(DataLinkResourceConfigBase):
    ...
    def compose_predefined_config(self, data_source: "DataSource") -> dict[str, Any]:
        ...
        """
        maintainer = settings.metadata.bk_data_project_maintainer.split(",")
    ...
    def compose_config(
        self, event_type: str = "metric", prefer_kafka_cluster_name: str | None = None
    ) -> dict[str, Any]:
        """
        数据源下发计算平台的资源配置
        """
