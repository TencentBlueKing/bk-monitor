...
from bk_monitor_base.metadata.models.constants import EventGroupStatus
from bk_monitor_base.metadata.models.custom_report.base import CustomGroupBase
from bk_monitor_base.metadata.models.result_table import ResultTableField, ResultTableOption
from bk_monitor_base.metadata.models.storage import ClusterInfo, ESStorage
...
class EventGroup(CustomGroupBase):
    ...
    DEFAULT_RESULT_TABLE_OPTIONS: dict[str, Any] = {
        "need_add_time": True,
    ...
    # 默认ES配置信息
    STORAGE_ES_CONFIG = {
        "retention": settings.metadata.ts_data_saved_days,
        # 默认1天区分一个index
        "slice_gap": 60 * 24,
        "date_format": "%Y%m%d",
...
class Event(models.Model):
    ...
    dimension_list = models.JSONField(verbose_name="维度列表", default=list)
