...
from bk_monitor_base.metadata.models.data_source import DataSourceOption, DataSourceResultTable
from bk_monitor_base.metadata.models.result_table import ResultTable, ResultTableOption
...
class CustomGroupBase(models.Model):
    ...
    def set_table_id_disable(self):
        ...
        for table in ResultTable.objects.filter(table_id=self.table_id, bk_tenant_id=self.bk_tenant_id):
            table.modify(operator=get_request_username(settings.blueking.common_username), is_enable=False)
    ...
    def create_custom_group(
        ...
        **kwargs,
        ...
        from bk_monitor_base.metadata.task.tasks import refresh_custom_report_config
    ...
    def modify_custom_group(
        ...
        metric_info_list: list[Any] | None = None,
