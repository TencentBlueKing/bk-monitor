...
class BkCollectorComp:
    ...
    @classmethod
    def get_secrets_config_map_by_protocol(cls, cluster_id: str, protocol: str) -> dict[str, Any] | None:
        from bk_monitor_base.metadata.config import settings

        special_secrets_config = settings.metadata.custom_report_k8s_secrets_config.get(cluster_id)
