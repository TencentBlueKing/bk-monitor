...
from bk_monitor_base.metadata.dataflow.exceptions import DataFlowNodeUpdateFailed, DataFlowNodeCreateFailed
...
class Node(six.with_metaclass(abc.ABCMeta, object)):
    ...
    def update(self, flow_id, node_id):
        ...
        try:
            ...
            raise DataFlowNodeUpdateFailed(f"{self.name}") from e
    ...
    def create(self, flow_id):
        ...
        try:
            ...
            raise DataFlowNodeCreateFailed(f"{self.name}") from e
