...
from bk_monitor_base.metadata.models.entity_relation import NAMESPACE_ALL, RelationDefinition, ResourceDefinition
from bk_monitor_base.metadata.resources.entity_relation import ENTITY_REDIS_CHANNEL_SUFFIX, ENTITY_REDIS_KEY_PREFIX
